    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100" style={{ '--accent': primaryColor } as any}>
      <div className="border-b border-zinc-800 bg-zinc-900 px-8 py-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-x-3 text-sm">
          ...
          <button onClick={() => router.push('/')} className="px-6 py-3 text-zinc-400 hover:text-white transition-colors">← New Domain</button>
        </div>
      </div>
          ...
          <div className="flex-1 bg-zinc-900 border border-zinc-800 rounded-3xl p-8 flex flex-col shadow-2xl">
            ...
            <div className="space-y-8 flex-1">
              ...
              <div>
                ...
                <textarea value={meetingNotes} onChange={(e) => setMeetingNotes(e.target.value)} rows={5} className="w-full px-5 py-4 bg-zinc-800 border border-zinc-700 rounded-3xl focus:border-[var(--accent)] outline-none resize-none text-lg" />
              </div>
            </div>
            ...
            >
              {isProcessing ? (
                <> <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin"></div> EXECUTING LOCAL REDACTION... </>
              ) : (
              ...
              <div className="space-y-8">
                ...
                <div>
                  <div className="flex items-center gap-x-2 mb-3">
                    ...
                    <h3 className="uppercase text-xs tracking-widest">Cloud LLM Summary (SANITIZED ONLY)</h3>
                  </div>
